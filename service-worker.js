/* Freedom at 50 — service worker v1.8.1 */
const CACHE_NAME = "freedom-at-50-v1.8.1";
const APP_SHELL = ["./","./index.html","./manifest.webmanifest","./icon-192.png","./icon-512.png","./freedom-mobile-wallpaper.jpg"];
